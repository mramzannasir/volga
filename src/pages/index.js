  ...
  return (
    <div className='w-full'>
      ...
      <main className='w-full'>
          ...
          <div className="w-full contain flex-col h-[490px] md:h-[600px] lg:h-[650px] xl:h-[750px] 2xl:h-[810px] 3xl:h-[810px]">
            ...
            <section className='w-full mt-[3rem] md:mt-[7rem] lg:mt-[8rem] xl:mt-[10rem]'>
              <div className='w-full md:w-[70%] xl:w-[66%]'>
                <h1 data-aos="fade-up" className='headings text-white text-center md:text-left'>Streamlining your supply chain, one truck at a time.</h1>
                <p data-aos="fade-up" className='description text-white opacity-70 my-2 xl:my-4 text-center md:text-left'>Our company, Volga Express Truck Rental offers a variety of trucks for rent. We provide reliable transportation for businesses. Contact us for all your truck rental needs.</p>
                <div data-aos="fade-left" className="flex justify-center w-full md:justify-start">   <button className='text-white border-none outline-none h-[48px] w-[141px] rounded-md flex items-center justify-center bg-red'>Get a Quote</button></div>
              </div>
              {/* Slider */}
            </section>
          </div>
        ...
        {/* Image Section-3 */}
        <div className='wrapper '>
          <div data-aos="zoom-out" className='relative w-full'>
        ...
        <div className="wrapper bg-[#F9F9FB] mt-6  relative ">
          <div className="contain flex-col justify-center py-[60px] md:py-[80px] xl:py-[120px] items-center">
            <h1 data-aos="fade-up" className='title text-black text-center'>Ready to join the team</h1>
            <p data-aos="fade-down" className='description my-[12px] md:my-[24px]  text-normalblack  text-center'>Lease to our carrier When you lease with us , you choose the loads that meet your specific business needs. you can go home when you want and load out when you’re ready. There is no forced dispatch.
