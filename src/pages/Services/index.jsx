        ...
        <div className="contain flex-col lg:flex-row items-stretch lg:gap-3 justify-center">
          ...
          <div data-aos="fade-left" className="w-full lg:w-[48%] ">
            ...
            <div className="w-full mt-2 p-1 sm:p-2 md:p-3">
              ...
              <ul className="text-normalblack description list-outside list-disc pl-5 xl:pl-8">
                <li>
                  Find freight that best matches the profile for the client.
                </li>
                <li>
                  Upon the client agreeing to the load, dispatcher will fax to
                  shipper/broker the clients W-9, authority and proof of
                  insurance and order insurance certificates if required, along
                  with any other required supporting documentation.
                </li>
                <li>
                  Handle the settling and confirmation of appointments if
                  necessary.
                </li>
                <li>Prepare directions to shipper/consignee, if necessary.</li>
                <li>
                  Assist with any problems that arise in the transit of the
                  load, when necessary, or within our capabilities. The client
                  is responsible for{" "}
                </li>
                <li>
                  Dispatcher will notify Client of best-matched loads for
                  approval prior to making a haul commitment.
                </li>
                <li>
                  Dispatcher will fax or email all necessary documentation to
                  broker/shipper directly, along with final approval once Client
                  has approved load or a designated representative
                </li>
                <li>Lease on</li>
              </ul>
            </div>
